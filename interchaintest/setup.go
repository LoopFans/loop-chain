...
var (
	...
	ChainImage = ibc.NewDockerImage("loopchain", "local", "1025:1025")
	...
	DefaultGenesis = []cosmos.GenesisKV{
		...
		cosmos.NewGenesisKV("app_state.poa.params.admins", []string{"loop10d07y265gmmuvt4z0w9aw880jnsr700j4m0ya0", "loop1hj5fveer5cjtn4wd6wstzugjfdxzl0xpf4wn8l"}),
